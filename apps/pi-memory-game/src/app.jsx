...
const Icon = ({ className, size = 24, children }) => (
          ...
          <div className="text-center">
            <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-6 ${
              ...
              {correctDigits === PI_DIGITS.length
                ...
                : <XIcon className="text-red-600" size={48} />
              }
            </div>
            ...
            <div className="text-sm text-gray-600 mb-6 font-mono break-all">
              ...
              <p>3.<span className="text-green-600">{input.slice(0, correctDigits)}</span>
                {wrongDigit && <span className="text-red-600">{wrongDigit}</span>}
              </p>
            </div>
